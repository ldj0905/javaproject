...
<body>
            ...
            <div class="mt-2 card">
                ...
                <div class="card-body">
                    <form id="modifyForm">
                        ...
                        <div class = "mt-2 d-none"> <!-- d-none => div 안에있는걸 화면에 제공하지 않겠다. -->
                ...
                <div class ="card-footer">
                    <button id = "btnUpdate" class = "btn btn-outline-success">업데이트</button> <!--  수정한거 저장하기 -->
                    <button id = "btnDelete" class = "btn btn-outline-danger">삭제</button> <!-- 글삭제  -->
                </div>
            </div>
        </main>
    </div>
    ...
    <script
        src="../js/post_modify.js"  ${post_modify_js}></script>
</body>
</html>